...
${OBJECTDIR}/counter_constants.o: counter_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/counter_constants.o counter_constants.cpp

${OBJECTDIR}/counter_types.o: counter_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/counter_types.o counter_types.cpp
