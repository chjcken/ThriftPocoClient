...
void Account::__set_visitor(const int val) {
  this->visitor = val;
}

const char* Account::ascii_fingerprint = "EEBC915CE44901401D881E6091423036";
const uint8_t Account::binary_fingerprint[16] = {0xEE,0xBC,0x91,0x5C,0xE4,0x49,0x01,0x40,0x1D,0x88,0x1E,0x60,0x91,0x42,0x30,0x36};
...
uint32_t Account::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("visitor", ::apache::thrift::protocol::T_I32, 2);
...
void ServerFigure::__set_totalVisitor(const int val) {
  this->totalVisitor = val;
}

const char* ServerFigure::ascii_fingerprint = "9588C61CD15F295DFB8708BE1D96FF9D";
const uint8_t ServerFigure::binary_fingerprint[16] = {0x95,0x88,0xC6,0x1C,0xD1,0x5F,0x29,0x5D,0xFB,0x87,0x08,0xBE,0x1D,0x96,0xFF,0x9D};
...
uint32_t ServerFigure::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->totalVisitor);
...
uint32_t ServerFigure::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("totalVisitor", ::apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->totalVisitor);
  xfer += oprot->writeFieldEnd();
